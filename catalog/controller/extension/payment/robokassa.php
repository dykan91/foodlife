...
class ControllerExtensionPaymentRobokassa extends Controller {
	public function index() {
		...
		if($this->config->get('payment_robokassa_test')) {
			$data['action'] = 'https://test.robokassa.ru/Index.aspx';
		} else {
			$data['action'] = 'https://auth.robokassa.ru/Merchant/Index.aspx';
		}

		$data['mrh_login'] = $this->config->get('payment_robokassa_login');
	    $data['mrh_pass1']= $this->config->get('payment_robokassa_password1');
	...
	public function success() {
		$mrh_pass1 = $this->config->get('payment_robokassa_password1');
	...
	public function callback() {
		$mrh_pass2 = $this->config->get('payment_robokassa_password2');
